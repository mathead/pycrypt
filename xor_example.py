"""
Solves the first cipher here https://class.coursera.org/crypto-preview/quiz/attempt?quiz_id=18
You have to help it a bit, the correct key is commented below
"""
import pycrypt as pc

class MulXorTranslator(pc.Translator):
	"""Translator for multiple XOR cipher texts with same pad"""
	def __init__(self):
		self.xorTrans = pc.XorTranslator()
...
# After a few minutes, you can start guessing the words and then setting the starting point to the key like below (its already solved)
